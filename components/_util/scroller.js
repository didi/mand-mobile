...
export default class Scroller {
      ...
      if (this._isSingleTouch && this.options.animating && timeStamp - this._lastTouchMove <= 100) {
        ...
        if (startPos !== endPos) {
          ...
          const minVelocityToStartDeceleration =
            this.options.paging || this.options.snapping ? this.options.snappingVelocity : 0.1
  ...
  _startDeceleration(timeStamp) {
    ...
    const minVelocityToKeepDecelerating = this.options.snapping ? this.options.snappingVelocity : 0.1
