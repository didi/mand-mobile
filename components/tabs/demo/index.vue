...
export default {
  ...createDemoModule('tabs', [Demo0, Demo1, Demo2, Demo3, Demo4, Demo5, Demo6, Demo7, Demo8, Demo9, Demo10, Demo11]),
}
</script>

<style lang="stylus">
.md-example-child-tabs .md-tab-content
  background #f
  height 100px
  line-height 100px
  text-align center
